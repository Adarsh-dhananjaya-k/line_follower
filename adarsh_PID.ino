...
const int motorRPin2 = 9;  // signal pin 2 for the right motor, connect to IN2
const int motorREnable = 3; // enable pin for the right motor (PWM enabled)

const int motorLPin1 = 2; // signal pin 1 for the left motor, connect to IN3           
const int motorLPin2 = 11; // signal pin 2 for the left motor, connect to IN4
const int motorLEnable = 10;
